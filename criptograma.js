...
const icons = [
  'fa-tree', 'fa-bolt', 'fa-heart', 'fa-star', 'fa-flag', 'fa-key', 'fa-fish',
  'fa-envelope', 'fa-lightbulb', 'fa-cog', 'fa-fire', 'fa-ghost', 'fa-paper-plane',
  'fa-bolt', 'fa-sun', 'fa-lock', 'fa-music', 'fa-cloud', 'fa-bug', 'fa-umbrella', 'fa-bell'
];
...
for (let i = 0; i < 165; i++) {
  ...
  if ([0, 17, 18, 29, 78, 123].includes(i)) {
    ...
    iconClass = 'fa-key';
  } else if ([14, 34, 36, 56, 71, 82, 90, 92, 115, 118, 134, 155, 161].includes(i)) {
    iconClass = 'fa-fish';
  ...
  if (i === 2) {
    iconClass = 'fa-heart'; // Ícone específico para o índice 2
  } else if (i === 50) {
  ...
  if ([2, 13, 24, 35, 46, 57, 68, 79, 91, 102, 114, 125, 136, 147, 158].includes(i)) {
